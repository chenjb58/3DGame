...
public class CCPhysicActionManager : SSActionManager, SSActionCallback, IActionManager
{
    ...
    public void MoveDisk(Disk disk)
    {
        ...
        CCPhysicAction action = CCPhysicAction.getAction(disk.speed); //实例化为物理运动对象
